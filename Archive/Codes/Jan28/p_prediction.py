...
def phos_pred_func(heat):
    ...
    ads['dololime_setup_o']=3
    ads['dolo_blow_o']=0
    ads['lime_blowi_o']=10.05
    ads['lime_arc_o']=0
    ads['dolo_arc_o']=0
...
def main():
    ...
    conarc_flux_data=pd.read_sql("SELECT * FROM conarc_flux_data where HEAT_NUMBER in ('22100684') and HM_WT >0", conn)
    ...
    #print(heat_status_check)
    heat_status_check=heat_status_check[heat_status_check['HEAT_NUMBER']=='22100684']
    #print(heat_status_check)
