...
def main():
    ...
    # conarc_flux_data= pd.read_sql("SELECT TOP(1000) * FROM conarc_flux_data where HEAT_NUMBER = '22302645' and  HM_WT >0 order by MSG_TIME_STAMP desc", conn)
    ...
    heat_status_check=heat_status_check[heat_status_check['HEAT_NUMBER']=='22302645']
