...
def optimization_func(running_heats, model_run):
    ...
    try:
        ...
        material_chem_data= pd.read_sql("SELECT TOP(10000) * FROM mat_chem_ana order by INSERT_DATE desc", conn)
        ...
        # print(lime_chem_data['CAO_PER'].values[0]/100,lime_chem_data['MGO_PER'].values[0]/100,dolo_chem_data['CAO_PER'].values[0]/100,dolo_chem_data['MGO_PER'].values[0]/100,dri_chem_data['CAO_PER'].values[0]/100 ,dri_chem_data['MGO_PER'].values[0]/100)

        #cao
        print(dolo_chem_data['CAO_PER'].values[0]/100)
        ...
        print('data before optimization : ',opti_df)
