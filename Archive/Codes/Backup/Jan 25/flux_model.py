...
def optimization_func(running_heats, model_run):
    ...
    opti_df['dri_blow_assumed'][opti_df['updated_arcing_flag']==0]=bath_wt_assumed-opti_df['hotmetal']-opti_df['scrap']
    ...
    opti_df['dri_arc'][opti_df['updated_arcing_flag']==1]=bath_wt_assumed-opti_df['hotmetal']-opti_df['dri_blow']
    ...
    opti_df['blowing_cao'] = opti_df['blowing_sio2'] * basicity
    opti_df['arcing_cao'] = opti_df['arcing_sio2'] * basicity

    opti_df['blowing_cao_assumed'] = opti_df['blowing_sio2_assumed'] * basicity
...
#        model_run=row['model_run_number']
    ...
    try:
        ...
        if model_run==1:
            opti_df['dololime_setup_o'] = opti_df['dolo_blow_o'].apply(lambda x: dolo_setup_limit if x > dolo_setup_limit else x)
            opti_df['dolo_blow_o'] = 0 # (opti_df['dolo_blow_o']-opti_df['dololime_setup_o'])*(1-opti_df['updated_arcing_flag']) #0
            opti_df['lime_blowi_o'][opti_df['updated_arcing_flag']==0] = opti_df['lime_blowi_o']+ opti_df['lime_excess']
...
def main():
    ...
    #heat_status_check=heat_status_check[heat_status_check['HEAT_NUMBER']=='22300100']
