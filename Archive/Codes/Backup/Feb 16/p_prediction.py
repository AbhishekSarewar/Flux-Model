...
def phos_pred_func(heat):
    ...
    #ads['o2toplance']=9766#ads['o2toplance']
    #ads['o2decarb']=313#ads['o2toplance']
...
def main():
    ...
    #conarc_flux_data=pd.read_sql("SELECT * FROM conarc_flux_data where HEAT_NUMBER in ('22100393') and HM_WT >0", conn)
    ...
    #print(heat_status_check)
    #heat_status_check=heat_status_check[heat_status_check['HEAT_NUMBER']=='22100393']
    #print(heat_status_check)
